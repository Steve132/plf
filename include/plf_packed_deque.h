...
private:
	...
	typedef std::deque<package, typename std::allocator_traits<allocator_type>::template rebind_alloc<package>> package_deque;
	typedef std::deque<package_pointer_type, typename std::allocator_traits<allocator_type>::template rebind_alloc<package_pointer_type>> package_pointer_deque;
